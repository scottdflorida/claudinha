...
export const ptBR: Strings = {
  ...
  launchFormUI: {
    ...
    mainConflictsWarning: '⚠ Os terminais rodam direto no repositório, na branch atual — mudanças entram na hora e agentes simultâneos podem colidir.',
  ...
  kanban: {
    ...
    columnAwaitingOrders: 'Aguardando ordens',
    columnPlanning: 'Planejando',
    columnPlanReady: 'Plano pronto',
    columnWorking: 'Trabalhando',
    columnTodo: 'A fazer',
    columnInProgress: 'Em andamento',
    columnNeedsInput: 'Precisa de entrada',
    columnDone: 'Concluído',
    columnChangesReady: 'Mudanças prontas',
    columnError: 'Erro',
    columnPaused: 'Pausados',
    nextStepCommit: (added: number, removed: number): string => `+${added}/-${removed} para commit`,
    nextStepMerge: (n: number): string => (n === 1 ? '1 commit para mesclar' : `${n} commits para mesclar`),
    nextStepPush: (n: number): string => `↑${n} para enviar`,
    nextStepPrOpen: (num: number): string => `PR #${num} aberto`,
    emptyColumn: 'Vazio',
  ...
  changesReadyModal: {
    ...
    viewDiffs: 'Ver diffs',
    discard: 'Descartar',
    discardTooltip: 'Fechar terminal e remover o worktree',
    actionCommit: 'Commit',
    actionCommitting: 'Commitando',
    actionCommitted: 'Commitado',
    actionCommitFailed: 'Commit falhou',
    actionMergeToMain: 'Mesclar na main',
    actionMerging: 'Mesclando',
    actionMerged: 'Mesclado',
    ...
    actionCreatePr: 'Criar PR',
    actionCreatingPr: 'Criando PR',
    actionPrOpened: 'PR aberto',
    actionPrFailed: 'PR falhou',
    actionQueued: 'Em fila',
    actionAwaitingCommit: 'Aguardando commit',
    actionAwaitingMerge: 'Aguardando merge',
    actionAwaitingPush: 'Aguardando push',

 ...
 */
export function KanbanColumn({ status, title, panes, activePaneId, onCardClick, onDiffClick, onCloseCard, onResolveDirtyMain, onResolveConflict, cardRefs, dropTargetRef, compactionDurationMs }: KanbanColumnProps): React.JSX.Element {

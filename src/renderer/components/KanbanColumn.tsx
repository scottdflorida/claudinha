 ...
 */
export function KanbanColumn({ status, title, panes, activePaneId, onCardClick, onDiffClick, onCloseCard, onResolveDirtyMain }: KanbanColumnProps): React.JSX.Element {

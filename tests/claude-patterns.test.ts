...
// classifyStopOutput was removed when the Stop-hook router was rewritten to
// consult plan mode + the worktree diff probe instead of scanning the PTY
// tail for question patterns. See HookListener.routeStopStatus.
